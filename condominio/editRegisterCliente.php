  ...
  <div class="container">
    <div class="row">
      ...
      //$sql =" INSERT INTO `clientes`( `nome`, `telefone_celular`, `email`, `CPF`, `endereco`, `complemento`, `cidade`, `UF`, `CEP`) 
         ...
         $sql =" UPDATE `clientes` set `nome` = '$nome', `telefone_celular` = '$telefone_celular', `email` = '$email', `CPF` = '$CPF', `endereco` = '$endereco', `complemento` = '$complemento', `cidade` = '$cidade', `UF` = '$UF', `CEP` = '$CEP' WHERE cod_pessoa = $id";

      if (mysqli_query($conn, $sql)){
	      mensagem( "$nome alterado com sucesso!",'info');
      } else
